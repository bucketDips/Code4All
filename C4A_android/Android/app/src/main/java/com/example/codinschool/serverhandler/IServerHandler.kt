...
interface IServerHandler {
    ...
    fun getAllExerciceFromStoreNotOwned(tokenSaved: String, callbackJsonArray: IAPICallbackJsonArray)
    fun forkThisExerciceWithTheUser(tokenSaved: String, idExercice: Int, callback: IAPICallbackJsonObject)
}