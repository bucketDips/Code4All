...
import com.codinschool.android.serverhandler.pixabay.IAPIHandler;
...
public class ServerHandler implements IServerHandler, IAPIHandler {
    ...
    private final String get_all_store_exercices_not_owned = "/getAllStoreExercicesNotOwned";
    private final String add_exercice_to_user = "/addExerciceToUser";
    ...
    @Override
    public void getAllExerciceFromStoreNotOwned(@NotNull String token, @NotNull IAPICallbackJsonArray callback) {
        String url = rootUrl + exercices + get_all_store_exercices_not_owned;
